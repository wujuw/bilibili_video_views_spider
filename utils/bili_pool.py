...
#     SPACE_ID, '{}')
URL = 'https://api.bilibili.com/x/space/wbi/arc/search?mid={}&ps=30&tid=0&pn={}&keyword=&order=pubdate&platform=web&web_location=1550101&order_avoided=true&w_rid=4bf2c257edf58ff87cdd19875d875490&wts=1688801079'.format(
    SPACE_ID, '{}')
...
class BiliPool:
    ...
    def get_list():
        ...
        while True:
            ...
            content = json.loads(data.content)#.encodeing('utf-8')
